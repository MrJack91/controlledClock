...
\subsection{Funk}
%TODO @Dani Da fehlt noch ein Wort
Elektromagnetische Wellen sind seit jeher allgegenwärtig. Es gilt hier natürliche und von Menschen erzeugte elektromagnetische Wellen zu unterscheiden. Natürliche Elektromagnetische Wellen werden z.B. durch die Sonne oder durch @Dani[Wortfehlt] erzeugt. Im Laufe der Geschichte haben die Menschen diese Wellen entdeckt und damit begonnen diese für ihre Zwecke einzusetzen. (Kapitel \ref{Analyse:Hintergruende}).
...
%TODO Wird der Titel gebraucht?
\subsubsection{Langwellensender}
